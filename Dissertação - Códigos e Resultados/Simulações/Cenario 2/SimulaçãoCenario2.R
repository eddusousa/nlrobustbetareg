...
# se1 = 96354 ; se2 = 3 #Ficou bom
se1 = 48261 ; se2 = 3 #random seed
set.seed(c(se1,se2), kind="Marsaglia-Multicarry") #To ensure repeatability of the experiment
simulation_results_scenario3 <- compiled_simulate_nlrobust(N=1000,
                                                           n=c(40,80,160,320),
                                                           functions = c("exp"),
                                                           parameters = c(2),
                                                           contamination=0.05,
...
boxplot(simulation_results_scenario3$data$MLE$beta1,
        ...
        pch=16, 
        col = NULL)
abline(h = simulation_results_scenario3$coefficients$beta[1], col = "red", lwd=2, lty=2)
abline(v=4.5,lty=3,lwd=2)
legend(0.0, -1.07,"Ausência de contaminação",bty="n",cex=2.3)
legend(4.3, -1.07,"Presença de contaminação",bty="n",cex=2.3)

#######################
# beta 2
boxplot(simulation_results_scenario3$data$MLE$beta2,
        ...
        pch=16, 
        col = NULL)
abline(h = simulation_results_scenario3$coefficients$beta[2], col = "red", lwd=2, lty=2)
abline(v=4.5,lty=3,lwd=2)
legend(0.0, 0.77,"Ausência de contaminação",bty="n",cex=2.3)
legend(4.3, 0.77,"Presença de contaminação",bty="n",cex=2.3)

#######################
# gamma 1

boxplot(simulation_results_scenario3$data$MLE$gamma1,
        ...
        pch=16, 
        col = NULL)
abline(h = simulation_results_scenario3$coefficients$gamma[1], col = "red", lwd=2, lty=2)
abline(v=4.5,lty=3,lwd=2)
legend(0.0, 3.85,"Ausência de contaminação",bty="n",cex=2.3)
legend(4.3, 3.85,"Presença de contaminação",bty="n",cex=2.3)
...
boxplot(simulation_results_scenario3$data$SMLE$beta1,
...
boxplot(simulation_results_scenario3$data$SMLE$beta2,
...
boxplot(simulation_results_scenario3$data$SMLE$gamma1,
...
boxplot(simulation_results_scenario3$data$LSMLE$beta1,
...
boxplot(simulation_results_scenario3$data$LSMLE$beta2,
...
boxplot(simulation_results_scenario3$data$LSMLE$gamma1,
...
extract_tuning(object = simulation_results_scenario3,
               return_q = TRUE) -> constantes_cenario3

#######################
# SMLE

boxplot(constantes_cenario3$data$SMLE,
...
boxplot(constantes_cenario3$data$LSMLE,
...
extract_measures(object = simulation_results_scenario3,
